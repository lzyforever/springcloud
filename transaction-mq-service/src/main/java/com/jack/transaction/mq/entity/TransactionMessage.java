package com.jack.transaction.mq.entity;
 ...
 * 事务消息实体类
 */
@TableName(value = "transaction_message", desc = "事务消息表", author = "jack")
public class TransactionMessage {
    ...
    public static Orders[] ID_ORDERS = new Orders[] { new Orders("id", Orders.OrderType.ASC)};
    ...
    private int status = TransactionMessageStatusEnum.WAITING.getStatus();
