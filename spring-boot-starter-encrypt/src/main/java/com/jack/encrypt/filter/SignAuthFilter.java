package com.jack.encrypt.filter;

import com.jack.encrypt.autoconfigure.EncryptProperties;
import com.jack.encrypt.util.AesEncryptUtils;
import com.jack.encrypt.util.JsonUtils;
 ...
 * sign=加密(参数1：值1，参数2：值2，signTime：签名时间戳)
 */
