...
为此，我基于Spring Boot封装了一个Starter, 内置了AES加密算法。
...
增加加密的key配置：
```
spring.encrypt.key=881234jack1988sc
...
当我们访问 /get 接口时，返回的数据就是加密之后base64编码的格式。
...
js加密文件请参考spring-boot-starter-encrypt-demo中encrypt中的aes.js,crypto-js.js,pad-zeropadding.js
