...
public abstract class CollectionUtils {
    ...
    /**
     * 去除List中的重复元素，并保留原有的顺序
     * 去除规则：调用List中元素本身的equals方法，如相等则去除
     *
     * @param list
     * @return
     */
    public static <T> List<T> uniqueList(final List<T> list) {
        if (list == null) {
            return null;
        }
        java.util.Set<T> set = new java.util.TreeSet<T>(new Comparator<T>() {
