...
import com.jack.jdbc.annotation.AutoId;
import com.jack.jdbc.annotation.TableName;
import com.jack.jdbc.kengen.DefaultKeyGenerator;
import com.jack.jdbc.kengen.KeyGenerator;
import com.jack.jdbc.kengen.KeyGeneratorFactory;
import com.jack.jdbc.utils.*;
...
public class ExtendJdbcTemplate extends JdbcTemplate {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ExtendJdbcTemplate.class);
    ...
    public ExtendJdbcTemplate(String... poPackages) {
            ...
            try {
                ...
                for (Class<?> clazz : classList) {
                    ...
                    for (Field field : fields) {
                        ...
                        if (field.isAnnotationPresent(com.jack.jdbc.annotation.Field.class)) {
                            com.jack.jdbc.annotation.Field cf = field.getAnnotation(com.jack.jdbc.annotation.Field.class);
    ...
    public int[] batchUpdate(Class<?> entityClass, List<?> entitys, String pkField, String... excludeFields) {
        Assert.notNull(entitys);
        List<Object[]> allValues = new ArrayList<>();
        Set<String> set = new HashSet<>(excludeFields.length + 1);
        set.add(pkField);
    ...
    private void printSqlLog(String sql, Object... values) {
        if (System.getProperty("jack.show.sql") != null) {
     ...
     *
     * @param pack     PO类的包名（com.jack.enity）
     * @param author   PO类的创建者（jack）
     * @param savePath 保存的路径（E:\\entity）
     */
