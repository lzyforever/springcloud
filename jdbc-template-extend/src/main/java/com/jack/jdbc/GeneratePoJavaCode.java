...
import com.jack.jdbc.utils.StringUtils;
    ...
    public void generate(Connection conn, String pack, String author, String savePath) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                sbpackage.append("import com.jack.jdbc.annotation.Field;\r\n");
                sbpackage.append("import com.jack.jdbc.annotation.TableName;\r\n");
                ...
                while (crs.next()) {
                    ...
                    if (columnname.equals("id")) {
                        sbpackage.append("import com.jack.jdbc.annotation.AutoId;\r\n");
                        sb.append("\t\t@AutoId\r\n");
